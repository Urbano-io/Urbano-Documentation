...
[Start with Deconstruct Boundary :octicons-arrow-right-24:](../components/Deconstruct_Boundary.md){ .md-button .md-button--primary aria-label="Start with Deconstruct Boundary" }
